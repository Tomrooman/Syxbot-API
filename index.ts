...
const app = express();
const DB_name = process.env.NODE_ENV === 'test' ? 'syxbot-database-test' : 'syxbot-database';
const DB_url = `mongodb://${config.mongo.user}:${config.mongo.password}@localhost/` + DB_name;
